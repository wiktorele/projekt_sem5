...
public class Restaurant2 extends AppCompatActivity {
    ...
    View.OnClickListener backward = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(Restaurant2.this, MenuActivity.class);
    ...
    View.OnClickListener re = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(Restaurant2.this, Restaurant2.class);
            startActivity(intent);
        }
    };
        ...
        public void onClick(View v) {
            ...
            if(sign1.getText().toString().equals(firstImageName) && sign2.getText().toString().equals(secondImageName) && sign3.getText().toString().equals(thirdImageName)){
                ...
                if(i < images.length){
                    ...
                    sound = MediaPlayer.create(Restaurant2.this, R.raw.correct);
                    sound.start();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            check.setAlpha(0);
                            Intent intent = new Intent(Restaurant2.this, Restaurant3.class);
                            startActivity(intent);
                        }
                    }, 1200);
                }
                ...
                sound = MediaPlayer.create(Restaurant2.this, R.raw.wrong);
                sound.start();
